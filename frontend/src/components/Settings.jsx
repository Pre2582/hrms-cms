        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[85%] max-w-[320px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl z-50 max-h-[85vh] overflow-hidden flex flex-col"
            >
              {/* Header */}
              ...
              <div className="overflow-y-auto p-3 space-y-3">
                ...
                <motion.div
                  ...
                  className="bg-gray-50 dark:bg-gray-700 p-2.5 rounded-md"
                >
                  <label className="block text-[10px] font-semibold text-gray-700 dark:text-gray-300 mb-1.5 uppercase tracking-wider">
                    {t('theme')}
                  </label>
